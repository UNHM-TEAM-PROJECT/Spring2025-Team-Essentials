...
# Folder containing PDFs that have been redacted of certain information, uncomment to use
# PDF_FOLDER = "Redacted_Syllabi_Sp2025"
# OUTPUT_FOLDER = "outputs/compliance_reports2"
